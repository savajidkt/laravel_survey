<div class="pagestart page9">
  ...
  <div class="topgraybox">
    <table style="width: 100%; margin: 0 auto; padding: 0; vertical-align: top" cellpadding="0" cellspacing="0">
      <tr>
        <td style="width:50px;"> <img style="max-width:100%; height:auto;" src="{{asset('pdf/img/CulIcon.png')}}" alt="DevelIcon" /> </td>
  ...
  <div class="footerblock">
    <div style="position:relative; width:100%;">
      <div style="width:174px; position:absolute; top:-110px; right:-15px;">
        <img style="max-width:100%; height:auto;" src="{{asset('pdf/img/orange_graphics.png')}}" alt="Bandelli-Associates-Logo 1" />
      </div>
    </div>
