  ...
  <table style="width: 100%; margin: 0 auto; padding: 0; vertical-align: top" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td style="width:140px;" valign="top">
        <img style="max-width:100%; height:auto;" src="{{asset('pdf/img/EstablishingRapport.png')}}" alt="Bandelli-Associates-Logo 1" />
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style="width:140px;" valign="top">
        <img style="max-width:100%; height:auto;" src="{{asset('pdf/img/UnderstandingOthers.png')}}" alt="Bandelli-Associates-Logo 1" />
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style="width:140px;" valign="top">
        <img style="max-width:100%; height:auto;" src="{{asset('pdf/img/EstablishingDifferences.png')}}" alt="Bandelli-Associates-Logo 1" />
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style="width:140px;" valign="top">
        <img style="max-width:100%; height:auto;" src="{{asset('pdf/img/DevelopingTrust.png')}}" alt="Bandelli-Associates-Logo 1" />
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style="width:140px;" valign="top">
        <img style="max-width:100%; height:auto;" src="{{asset('pdf/img/CultivatingInfluence.png')}}" alt="Bandelli-Associates-Logo 1" />
      </td>
    </tr>
